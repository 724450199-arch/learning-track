...
$ddSvg = New-Svg @(
  ...
  '  <text x="60" y="245" font-size="16" fill="#333">1. c</text><line x1="72" y1="249" x2="90" y2="249" stroke="#E53935" stroke-width="2"/><text x="94" y="245" font-size="16" fill="#333">e (蛋糕)</text>',
  '  <text x="60" y="272" font-size="16" fill="#333">2. l</text><line x1="72" y1="276" x2="90" y2="276" stroke="#E53935" stroke-width="2"/><text x="94" y="272" font-size="16" fill="#333">e (湖)</text>',
  '  <text x="60" y="299" font-size="16" fill="#333">3. m</text><line x1="72" y1="303" x2="90" y2="303" stroke="#E53935" stroke-width="2"/><text x="94" y="299" font-size="16" fill="#333">e (制作)</text>',
  '  <text x="60" y="326" font-size="16" fill="#333">4. n</text><line x1="72" y1="330" x2="90" y2="330" stroke="#E53935" stroke-width="2"/><text x="94" y="326" font-size="16" fill="#333">e (名字)</text>',
  '  <text x="60" y="353" font-size="16" fill="#333">5. g</text><line x1="72" y1="357" x2="90" y2="357" stroke="#E53935" stroke-width="2"/><text x="94" y="353" font-size="16" fill="#333">e (游戏)</text>',
  ...
  '  <text x="60" y="448" font-size="15" fill="#333">I like to r</text><line x1="152" y1="452" x2="170" y2="452" stroke="#E53935" stroke-width="2"/><text x="174" y="448" font-size="15" fill="#333">e. (赛跑/race)</text>',
  '  <text x="60" y="478" font-size="15" fill="#333">She has a red c</text><line x1="192" y1="482" x2="210" y2="482" stroke="#E53935" stroke-width="2"/><text x="214" y="478" font-size="15" fill="#333">e. (披肩/cape)</text>',
  '  <text x="60" y="508" font-size="15" fill="#333">We m</text><line x1="110" y1="512" x2="128" y2="512" stroke="#E53935" stroke-width="2"/><text x="132" y="508" font-size="15" fill="#333">e a cake. (制作/make)</text>',
  ...
  '  <text x="70" y="605" font-size="18" fill="#333">3 + 2 = </text><line x1="158" y1="609" x2="200" y2="609" stroke="#E53935" stroke-width="2"/>',
  '  <text x="320" y="605" font-size="18" fill="#333">5 + 1 = </text><line x1="408" y1="609" x2="450" y2="609" stroke="#E53935" stroke-width="2"/>',
  '  <text x="70" y="640" font-size="18" fill="#333">7 - 3 = </text><line x1="158" y1="644" x2="200" y2="644" stroke="#E53935" stroke-width="2"/>',
  '  <text x="320" y="640" font-size="18" fill="#333">4 + 4 = </text><line x1="408" y1="644" x2="450" y2="644" stroke="#E53935" stroke-width="2"/>',
  '  <text x="70" y="675" font-size="18" fill="#333">9 - 2 = </text><line x1="158" y1="679" x2="200" y2="679" stroke="#E53935" stroke-width="2"/>',
  '  <text x="320" y="675" font-size="18" fill="#333">6 + 3 = </text><line x1="408" y1="679" x2="450" y2="679" stroke="#E53935" stroke-width="2"/>',
  '  <text x="70" y="710" font-size="18" fill="#333">8 - 5 = </text><line x1="158" y1="714" x2="200" y2="714" stroke="#E53935" stroke-width="2"/>',
  '  <text x="320" y="710" font-size="18" fill="#333">2 + 7 = </text><line x1="408" y1="714" x2="450" y2="714" stroke="#E53935" stroke-width="2"/>',
  '</svg>'
)
