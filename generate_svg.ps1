...
$ddSvg = New-Svg @(
  ...
  '  <text x="60" y="245" font-size="16" fill="#333">1. c<span fill="#E53935">_k</span>e (蛋糕)</text>',
  '  <text x="60" y="272" font-size="16" fill="#333">2. l<span fill="#E53935">_k</span>e (湖)</text>',
  '  <text x="60" y="299" font-size="16" fill="#333">3. m<span fill="#E53935">_k</span>e (制作)</text>',
  '  <text x="60" y="326" font-size="16" fill="#333">4. n<span fill="#E53935">_m</span>e (名字)</text>',
  '  <text x="60" y="353" font-size="16" fill="#333">5. g<span fill="#E53935">_m</span>e (游戏)</text>',
  ...
  '  <text x="60" y="448" font-size="15" fill="#333">I like to r<span fill="#E53935">_c</span>e. (赛跑/race)</text>',
  '  <text x="60" y="478" font-size="15" fill="#333">She has a red c<span fill="#E53935">_p</span>e. (披肩/cape)</text>',
  '  <text x="60" y="508" font-size="15" fill="#333">We m<span fill="#E53935">_k</span>e a c<span fill="#E53935">_k</span>e. (制作/make + cake)</text>',
