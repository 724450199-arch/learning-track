...
$ChineseContent = @{}
# ====== 2024新版人教版一年级上册 ======
# 第1周：我上学了 + 识字1《天地人》+ 识字2《金木水火土》
$ChineseContent[1] = @{pinyin="天地人 你我他 一二三四五"; chars="天地人 你我他 一二三四五 上下"; act="入学教育，找名字，教室物品认字"; poems=@(
...
# 第2周：识字3《口耳目》+ 识字4《日月水火》+ 识字5《对韵歌》
$ChineseContent[2] = @{pinyin="口耳目 日月水火 对韵歌"; chars="口耳目手足 站坐 日月水火山石田禾 对云雨风花鸟虫"; act="指五官游戏，字卡配图，对对子"; poems=@(
...
# 第3周：拼音1-4 (a o e, i u ü, b p m f, d t n l)
$ChineseContent[3] = @{pinyin="a o e i u ü b p m f d t n l"; chars="复习：一二三四五 上下 人口手"; act="拼音手指操，声母韵母配对"; poems=@(
...
# 第4周：拼音5-9 (g k h, j q x, zh ch sh r, z c s, y w)
$ChineseContent[4] = @{pinyin="g k h j q x zh ch sh r z c s y w"; chars="复习全部声母"; act="拼音接龙，声母分类游戏"; poems=@(
...
# 第5周：拼音10-14 (ai ei ui, ao ou iu, ie üe er, an en in un ün, ang eng ing ong)
$ChineseContent[5] = @{pinyin="ai ei ui ao ou iu ie ue er an en in un un ang eng ing ong"; chars="复习全部韵母"; act="韵母大转盘，配对游戏"; poems=@(
...
# 第6周：拼音总复习 + 拼读练习
$ChineseContent[6] = @{pinyin="全部拼音复习拼读"; chars="拼音识字总复习：大小上下 人口手 日月水火"; act="拼音闯关，BINGO游戏，拼读小故事"; poems=@(
...
# 第7周：课文1《秋天》+ 课文2《小小的船》
$ChineseContent[7] = @{pinyin="秋天 小小的船"; chars="了子人大 秋天树叶 的船两头 在里看见 闪星"; act="读课文找秋天，折纸船"; poems=@(
...
# 第8周：课文3《江南》+ 课文4《四季》
$ChineseContent[8] = @{pinyin="江南 四季"; chars="江南可采莲 鱼东西北 尖说春青蛙 夏弯冬就是"; act="画莲花小鱼，四季转盘"; poems=@(
...
# 第9周：识字6《画》+ 识字7《大小多少》+ 识字8《小书包》
$ChineseContent[9] = @{pinyin="画 大小多少 小书包"; chars="远近有色无声去还来 多少黄牛猫鸭果杏桃 书包作业本笔刀课早校"; act="猜谜画，比多少游戏，整理书包"; poems=@(
...
# 第10周：识字9《日月明》+ 识字10《升国旗》
$ChineseContent[10] = @{pinyin="日月明 升国旗"; chars="明力男尘从众双木林森 中五立正升国旗红歌起丽"; act="会意字猜猜看，升国旗仪式模仿"; poems=@(
...
# 第11周：课文5《影子》+ 课文6《比尾巴》+ 课文7《青蛙写诗》
$ChineseContent[11] = @{pinyin="影子 比尾巴 青蛙写诗"; chars="影前后左右 好朋友 比尾巴长短 伞猴鼠 写诗点要过 串们以成"; act="踩影子游戏，动物尾巴配对，角色扮演"; poems=@(
...
# 第12周：课文8《雨点儿》+ 课文9《明天要远足》+ 课文10《大还是小》+ 课文11《项链》
$ChineseContent[12] = @{pinyin="雨点儿 明天要远足 大还是小 项链"; chars="雨问答方没 自己时候觉得很穿 大小蓝又笑金"; act="雨滴实验，远足计划，比大小讨论"; poems=@(
...
# 第13周：课文12《雪地里的小画家》+ 课文13《乌鸦喝水》+ 课文14《小蜗牛》+ 全册总复习
$ChineseContent[13] = @{pinyin="雪地里的小画家 乌鸦喝水 小蜗牛"; chars="全册生字总复习 写自己名字"; act="雪地画动物，乌鸦喝水实验，蜗牛爬行，总复习闯关"; poems=@(
...
# ====== 多多数学（2024新版人教版一年级上册 共31周） ======
$MathContent = @{}
# 数学游戏（准备课）
$MathContent[1]  = @{ch="数学游戏"; topic="在校园里找一找 在操场上玩一玩"; act="🔍 校园寻宝 🏃 跳格子 🖐️ 数手指"}
$MathContent[2]  = @{ch="数学游戏"; topic="在教室里认一认 在教室里玩一玩"; act="🧮 教室物品数数 🎲 分类游戏 🧩 拼图"}
# 一、5以内数的认识和加、减法
$MathContent[3]  = @{ch="一、5以内"; topic="1~5的认识 比大小 第几"; act="🖐️ 手指表示 🎲 骰子比大小 🚂 火车第几节"}
$MathContent[4]  = @{ch="一、5以内"; topic="分与合 加法"; act="🧩 扣子分两份 🍎 苹果合起来 🏠 数字房子"}
$MathContent[5]  = @{ch="一、5以内"; topic="减法 0的认识和加减法"; act="🎈 气球飞走 🍪 吃掉了 🎯 射掉几个"}
# 二、6~10的认识和加、减法
$MathContent[6]  = @{ch="二、6~10"; topic="6~9的认识 比大小 第几"; act="🧮 十格框 🔟 手指数 🐸 青蛙跳"}
$MathContent[7]  = @{ch="二、6~10"; topic="6~9的分与合"; act="🧩 扣子分两份 🥣 分碗豆 🏠 数字分解屋"}
$MathContent[8]  = @{ch="二、6~10"; topic="6和7的加减法"; act="🐸 跳数轴 🎯 保龄球 🃏 闪卡速算"}
$MathContent[9]  = @{ch="二、6~10"; topic="8和9的加减法"; act="🕷️ 蜘蛛腿计数 🎈 加减气球 🎲 骰子游戏"}
$MathContent[10] = @{ch="二、6~10"; topic="10的认识和加减法"; act="✋ 手指凑十 🧮 十格框 🥚 鸡蛋盒"}
$MathContent[11] = @{ch="二、6~10"; topic="连加连减 加减混合"; act="🐸 青蛙跳三步 📿 串珠加減 🎪 三步闯关"}
# 三、认识立体图形
$MathContent[12] = @{ch="三、立体图形"; topic="认识长方体/正方体/圆柱/球"; act="📦 积木分类 🏗️ 搭城堡 🖐️ 摸形状猜"}
$MathContent[13] = @{ch="三、立体图形"; topic="拼搭 滚一滚 立体图形与平面"; act="🧱 积木拼搭 🔄 滚一滚比赛 ✏️ 描轮廓"}
# 四、11~20的认识
$MathContent[14] = @{ch="四、11~20"; topic="10加几 认识11~20 数位"; act="🧮 计数器 💰 十位个位 🧱 积木搭十"}
$MathContent[15] = @{ch="四、11~20"; topic="11~20比大小 排序 简单加减法"; act="📿 串珠比大小 🎲 抽卡排序 🧮 十位个位计算"}
# 五、20以内的进位加法
$MathContent[16] = @{ch="五、20以内进位"; topic="9加几（凑十法）"; act="🧮 凑十法 🥚 鸡蛋盒凑十 🎯 投掷计分"}
$MathContent[17] = @{ch="五、20以内进位"; topic="8、7、6加几"; act="🐸 跳数轴 🧩 拆小数凑大数 🃏 闪卡"}
$MathContent[18] = @{ch="五、20以内进位"; topic="5、4、3、2加几"; act="🎲 骰子速算 🏪 小商店 🏆 口算比赛"}
# 六、总复习
$MathContent[19] = @{ch="六、总复习"; topic="5以内+6~10 数的认识与加减"; act="🔄 数字大闯关 🎪 游园会"}
$MathContent[20] = @{ch="六、总复习"; topic="立体图形 11~20 进位加法"; act="🔄 图形寻宝 🧮 计数器挑战 🏆 期末闯关"}
$MathContent[21] = @{ch="拓展"; topic="20以内退位减法（下册预备）"; act="🍬 分糖果 🎈 减气球 📖 故事应用题"}
$MathContent[22] = @{ch="拓展"; topic="100以内数初步 整十数"; act="🧮 百数表 🧱 积木100 🔢 数数"}
$MathContent[23] = @{ch="拓展"; topic="认识人民币（元角分）"; act="🏪 模拟商店 💵 换零钱 🧾 算账游戏"}
$MathContent[24] = @{ch="拓展"; topic="认识钟表（整点半点）"; act="⏰ 纸盘钟 🎬 一日计划 🗓️ 时间配对"}
$MathContent[25] = @{ch="拓展"; topic="找规律 图形与数字"; act="🧩 颜色规律 🔢 数字规律 🎨 创造规律"}
$MathContent[26] = @{ch="拓展"; topic="分类与整理"; act="🧸 玩具分类 🍎 水果分类 📊 画统计图"}
$MathContent[27] = @{ch="拓展"; topic="位置（上下前后左右）"; act="📍 寻宝地图 🧭 指令游戏 🐭 老鼠在哪"}
$MathContent[28] = @{ch="拓展"; topic="长度比较 轻重比较"; act="✋ 拃量 📏 比身高 ⚖️ 天平比较"}
$MathContent[29] = @{ch="拓展"; topic="图文应用题 解题策略"; act="📖 看图列式 🎯 找出关键信息 🧩 画图解题"}
$MathContent[30] = @{ch="拓展"; topic="上册总复习挑战（一）"; act="🏆 闯关游戏 薄弱点巩固"}
$MathContent[31] = @{ch="拓展"; topic="上册总复习挑战（二）+ 下学期展望"; act="🏆 期末大闯关 🎯 新学期目标"}
